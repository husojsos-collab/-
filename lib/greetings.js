...
const { formatLocalDateTime } = require('./country-time');
    ...
    if (action === 'add') {
      for (const p of participants || []) {
        ...
        const banner = [
          '⌬──══─┈•⤣⚡⤤•┈─══──⌬',
          '',
          ' ִᗀᩙᰰ ̼𝆬🔥̸ ᮭ࣪࣪ ⸼۫   𝗧𝗢𝗚𝗜 𝗕𝗢𝗧 𖤍𝅄 ۫ ִᗀᩙᰰ ̼𝆬🔥',
          '',
          '🌟 *مـرحـبـاً بـك بـالـمـجـمـوعـة:*',
          '',
          `> 👤 العضو: @${number}`,
          `> 📅 التاريخ: ${dateStr}`,
          `> ⏰ الوقت: ${timeStr}`,
