...
const BAD_WORDS = [
  'قحبة', 'قحبه', 'كحبة', 'كحبه', 'شرموطة', 'شرموطه', 'شرموطتي', 'شراميط', 'عاهرة', 'عاهره', 'عاهرات',
  'كس امك', 'كسامك', 'كص امك', 'كصامك', 'كصامكم', 'كس اختك', 'كساختك', 'كس ابوك', 'كسابوك', 'كس اهلك', 'كساهلك',
  'كسك', 'كصك', 'كسمك', 'كصمك', 'كسختك', 'كصختك',
  'زب', 'زبي', 'زيب', 'الزب', 'صب', 'زبك', 'زبي فيك', 'زبك فيك', 'زب فيك', 'زبتك', 'يا زب', 'طيزك', 'طيز', 'نيك', 'نيكامك', 'نيك امك', 'نياك', 'منيوكة', 'واد الزنا', 'بنت الزنا', 'ولد الحرام', 'ابن الحرام', 'بنت الحرام',
  'خول', 'خولات', 'لوطي', 'متناك', 'منيك', 'كلب ابن كلب', 'ابن كلب', 'يا كلب', 'ابن الوسخة', 'ابن القحبة', 'ابن الشرموطة',
  // إضافات (طلب حماية الجروب - 13/7/2026)
  'سكس', 'طبون', 'طبونمك', 'منيوك', 'خرا', 'حيوان قذر', 'وسخة', 'زانية', 'زاني'
];
...
function kickBanner(targetLine, executorLine) {
  return [
    '╭━━━ 🌸 『 ✨ 𝑨𝑳𝒀𝑨-𝑪𝑯𝑨𝑵 ✨ 』 🌸 ━━━╮',
    '┃  👢 *تــم طــرد الــعــضــو بــنــجــاح*',
    '┣━━━━━━━━━━━━━━━━━━━━━━━━━━⫸',
    `┃  👤 *الــمــســتــخــدم :* ${targetLine}`,
    `┃  👑 *مــنــفّــذ الــطــرد :* ${executorLine}`,
    '┃  ⚡ *الــحــالــة :* تم التنفيذ بواسطة النظام 🌸',
    '╰━━━━━━━━━━━━━━━━━━━━━━━━━━╯',
    '',
    '🌸 *تنويه لطيف من أليا تشان:*',
    'تمت إزالة العضو للحفاظ على النظام والأجواء الطيبة في المجموعة ✨💖',
    '',
    '˼✨˹ ┃ *ALYA-CHAN تضمن لكم بيئة آمنة ولطيفة دائماً* 🎀'
  ].join('\n');
}

function newWarningBanner(targetLine, reasonText, count, max) {
  return [
    '╭━━━ 🌸 『 ✨ 𝑾𝑨𝒅𝑵𝑰𝑵𝑮 𝑵𝑶𝑻𝑰𝑪𝑬 ✨ 』 🌸 ━━━╮',
    '┃  ⚠️ *تــنــبــيــه مــخــالــفــة جــديــدة*',
    '┣━━━━━━━━━━━━━━━━━━━━━━━━━━⫸',
    ...
    '',
    '🌸 *تذكير لطيف:*',
    'نرجو من الجميع الالتزام بقوانين المجموعة والحفاظ على الأجواء الطيبة بين الأعضاء ✨',
    'تكرار المخالفات قد يؤدي إلى استبعادك تلقائياً للحفاظ على النظام 💖',
    '',
    '˼✨˹ ┃ *ALYA-CHAN في خدمتكم دائماً* 🌸'
  ].join('\n');
}

function finalWarningKickBanner(targetLine, reasonText) {
  const reason = reasonText || 'تجاوز الحد الأقصى للمخالفات';
  return [
    '╭━━━ 🌸 『 ✨ 𝑨𝑼𝑻𝑶 𝑲𝑰𝑪𝑲 𝑵𝑶𝑻𝑰𝑪𝑬 ✨ 』 🌸 ━━━╮',
    '┃  ⚠️ *تــنــبــيــه إزا لــة مــخــالــف*',
    '┣━━━━━━━━━━━━━━━━━━━━━━━━━━⫸',
    `┃  👤 *الــعــضــو :* ${targetLine}`,
    `┃  📝 *الــســبــب :* ${reason}`,
    `┃  📊 *عــدد الــتــحــذيــرات :* ${MAX_WARNINGS}/${MAX_WARNINGS}`,
    `┃  ⏰ *الــو قــت :* ${greetings.formatTripoliTime()}`,
    '╰━━━━━━━━━━━━━━━━━━━━━━━━━━╯',
    '',
    '🌸 *تنويه من أليا تشان:*',
    'تم طرد العضو تلقائياً لتجاوزه عدد التحذيرات المسموح بها حسب قوانين المجموعة ✨',
    '',
    '💖 نرجو من باقي الأعضاء الكرام الالتزام بالتعليمات والحفاظ على الود والاحترام بين الجميع لضمان بقائكم معنا في بيتنا اللطيف 🌸',
    '',
    '˼✨˹ ┃ *ALYA-CHAN تضمن لكم بيئة آمنة ولطيفة دائماً* 🎀'
  ].join('\n');
}
...
function violationDmBanner(reasonText, memberLine, count, max) {
  return [
    ...
    '╰━━━━━━━━━━━━━━━━━━━━━━━━━━╯',
    '',
    '🌸 *تذكير لطيف من أليا تشان:*',
    'نرجو منك الالتزام بقوانين المجموعة والحفاظ على الأجواء الطيبة بين الأعضاء ✨',
    'تكرار المخالفات قد يؤدي إلى استبعادك تلقائياً للحفاظ على النظام والنظافة العامة للمجموعة 💖',
    '',
    '˼✨˹ ┃ *ALYA-CHAN في خدمتكم دائماً* 🌸'
  ].join('\n');
}
...
function warningCountBanner(targetLine, count, max) {
  const statusLine = count >= max - 1 ? 'يرجى الحذر ⚠️' : 'مستقر وأنيق 🌸';
  return [
    '╭━━━ 🌸 『 ✨ 𝑨𝑳𝒀𝑨-𝑪𝑯𝑨𝑵 ✨ 』 🌸 ━━━╮',
    '┃  📊 *ســجــل الــتــحــذيــرات الــحــالــي*',
    '┣━━━━━━━━━━━━━━━━━━━━━━━━━━⫸',
    `┃  👤 *الــعــضــو :* ${targetLine}`,
    `┃  ⚠️ *عــدد الــتــحــذيــرات :* ${count}/${max}`,
    `┃  🌸 *حــالــة الــســجــل :* ${statusLine}`,
    '╰━━━━━━━━━━━━━━━━━━━━━━━━━━╯',
    '',
    '🌸 *ملاحظة من أليا تشان:*',
    'احرص دائماً على إبقاء سجلك خالياً من التنبيهات باتباع القواعد العامة للمجموعة ✨',
    `في حال وصولك إلى ${max} تحذيرات، سيتم اتخاذ إجراء الطرد تلقائياً لحماية نظام المجموعة 💖`,
    '',
    '˼✨˹ ┃ *دمتم واعين ومهذبين في مجتمعنا اللطيف* 🎀'
  ].join('\n');
}

function warningsResetBanner(targetLine, adminLine) {
  return [
    '╭━━━ 🧸 『 ✨ 𝑨𝑳𝒀𝑨-𝑪𝑯𝑨𝑵 ✨ 』 🧸 ━━━╮',
    '┃  ✨ *تــصــفــيــر ســجــل الــتــحــذيــرات*',
    '┣━━━━━━━━━━━━━━━━━━━━━━━━━━⫸',
    `┃  👤 *الــعــضــو :* ${targetLine}`,
    `┃  👑 *الــمــشــرف :* ${adminLine}`,
    '┃  🧹 *الــحــالــة :* تم مسح جميع المخالفات بنجاح 🌸',
    '╰━━━━━━━━━━━━━━━━━━━━━━━━━━╯',
    '',
    '🌸 *صفحة جديدة مع أليا تشان:*',
    'تم إعطاؤك فرصة جديدة لتبدأ من جديد! نثق في التزامك وأخلاقك العالية معنا في الفترة القادمة ✨💖',
    '',
    '˼✨˹ ┃ *ALYA-CHAN تتمنى للجميع إقامة سعيدة وممتعة* 🎀'
  ].join('\n');
}
...
async function punishProfanity(sock, persistDir, groupJid, msg, authorJid) {
  try {
    ...
    // المشرف مستثنى بالكامل (فحص موحّد بيجرب كل الحقول الممكنة: id/jid/lid/phoneNumber/pn)
    if (wa.isParticipantAdmin(meta, authorJid)) {
      return;
    }
    ...
    // (نفس الفحص المصحح المستخدم بباقي الفلاتر - يدعم حالة @lid)
    if (!wa.isBotAdmin(meta, sock.user)) {
      console.error('⚠️ فلتر الألفاظ: البوت مش أدمن بالجروب (أو فشلت مطابقة الهوية) - ما راح يعاقب.', groupJid);
      return;
    }
    ...
    if (newCount >= MAX_WARNINGS) {
      ...
      try {
        ...
        await sock.sendMessage(groupJid, {
          text: finalWarningKickBanner(numberTag, 'تجاوز الحد الأقصى للمخالفات (ألفاظ غير لائقة)'),
          mentions: [authorJid]
        });
        logKick(persistDir, {
          chatId: groupJid,
      ...
      await sock.sendMessage(groupJid, {
        text: newWarningBanner(numberTag, 'ألفاظ غير لائقة (سب/قذف)', newCount, MAX_WARNINGS),
        mentions: [authorJid]
      });
    }
  } catch (filterErr) {
